...
document.addEventListener("DOMContentLoaded", function () {
    ...
    map = L.map("map", {
        // Hapus 'var' agar tidak membuat variabel lokal baru
                    ...
                    if (!isNaN(lat) && !isNaN(lng)) {
                        ...
                        var popupContent = `
                            ...
                            item.kecamatan
                                ...
                                <!-- View Link -->
                                <a href="${wisataDetailUrl}/${
                            item.slug ?? ""
                        }" target="_blank" 
                                    class="group w-full bg-gradient-to-r from-emerald-400 to-cyan-400 hover:from-emerald-500 hover:to-cyan-500 text-white font-semibold py-2 px-3 rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center justify-center space-x-1 text-xs shadow-md">
